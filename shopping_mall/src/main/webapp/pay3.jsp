...
<body>
<form id="frm">
<input type="hidden" name="version" value="1.0"> <!-- api 버젼  -->
<!-- 결제방식  -->
...
<!-- 결제사항에 대한 정보를 SHA-256로 암호화 된 코드 -->
...
상품갯수 : <%=request.getAttribute("goodea")%><br>
<p>-------결제자정보-------</p>
...
결제수단 : <%=request.getAttribute("gopaymethod")%><br>
